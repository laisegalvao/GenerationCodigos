...
import com.escola.generationcrud.model.Turma;
import com.escola.generationcrud.repository.TurmaRepository;
...
public class TurmaController {
	...
	public ResponseEntity<Turma> getById(@PathVariable long id){
		...
		return repository.findById(id).map(escola -> ResponseEntity.ok(escola))
